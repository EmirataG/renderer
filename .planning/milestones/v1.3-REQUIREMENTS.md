# Requirements Archive: v1.3 Performance & Polish
...
### Playhead Cursor (DROPPED — Phase 15 removed from v1.3)
...
### Polish (DROPPED — Phase 15 removed from v1.3)
...
| CUR-01 | Phase 15 | Dropped |
| CUR-02 | Phase 15 | Dropped |
| CUR-03 | Phase 15 | Dropped |
| CUR-04 | Phase 15 | Dropped |
| CUR-05 | Phase 15 | Dropped |
| POL-01 | Phase 15 | Dropped |
| POL-02 | Phase 15 | Dropped |

**Coverage:**
- v1.3 requirements: 14 total
- Completed: 7 (VIRT-01–05, GAP-01–02)
- Dropped: 7 (CUR-01–05, POL-01–02 — Phase 15 removed from milestone)
